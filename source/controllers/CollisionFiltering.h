...
const short MASK_ENEMY_HITBOX =
    CATEGORY_WALL | CATEGORY_PLAYER | CATEGORY_SWORD | CATEGORY_PROJECTILE;

const short MASK_ENEMY_DAMAGE = CATEGORY_WALL | CATEGORY_PLAYER;

const short MASK_ENEMY_WALL = CATEGORY_WALL;
